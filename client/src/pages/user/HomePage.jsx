    ...
    <div id='homeContainer'>
      ...
      <div id="infoContainer">
        <form onSubmit={onSubmit} className='userSelectNone infoForm'>
          <Dropdown id={'carCompany'} values={carCompanyValues} placeholder={'-- Select Car Company --'} onChange={e => setCarCompany(e.target.value)} type={carCompany} name={'Car Company'} />

          <Dropdown id={'noOfSeats'} values={carModelValues} placeholder={'-- Select Car Model --'} onChange={e => setCarModel(e.target.value)} type={carModel} name={'Car Model'} />

          <Dropdown id={'yearOfPurchase'} values={yearOfPurchaseValues} placeholder={'-- Select Year of Purchase --'} onChange={e => setYearOfPurchase(e.target.value)} type={yearOfPurchase} name={'Year of Purchase'} />

          <Dropdown id={'fuelType'} values={fuelTypeValues} placeholder={'-- Select Fuel Type --'} onChange={e => setFuelType(e.target.value)} type={fuelType} name={'Fuel Type'} />
